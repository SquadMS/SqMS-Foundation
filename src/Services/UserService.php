...
class UserService
{
    ...
    public static function createOrUpdateBulk(array $steamUsers, bool $shallow = false)
    {
        ...
        /** @var \skyraptor\LaravelSteamLogin\SteamUser $steamUser */
        ...
        return UserHelper::getUserModel()->upsert($rows, ['steam_account_id'], $updateRows);
    }

    public static function createOrUpdate(SteamUser $steamUser, bool $shallow = false) : Model
    {
        return UserHelper::getUserModel()->updateOrCreate([
